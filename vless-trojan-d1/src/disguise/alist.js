/**
 * Alist-style disguise page (fully static, no external deps)
 */

export function buildDisguisePage(settings) {
	const title = settings.disguise_title || 'AList';
	const subtitle = settings.disguise_subtitle || '一个支持多存储的文件列表程序';
...
<body>
<div class="navbar">
  <div class="logo"><span>▤</span> ${title}</div>
  <div class="nav-right"><a href="#">首页</a><a href="#">更多</a><a href="#">登录</a></div>
</div>
<div class="container">
  <div class="breadcrumb">📁 <b>根目录</b></div>
  <div class="searchbar">
  ...
  <div class="table">
    ...
    <div class="file-row"><span><span class="icon">📄</span><span class="name">README.md</span></span><span class="meta">2.1 KB</span><span class="meta">2026-09-20 14:32</span></div>
    <div class="file-row"><span><span class="icon">📄</span><span class="name">index.html</span></span><span class="meta">8.6 KB</span><span class="meta">2026-09-19 09:15</span></div>
    <div class="file-row"><span><span class="icon">📂</span><span class="name">docs</span></span><span class="meta">-</span><span class="meta">2026-09-18 22:01</span></div>
    <div class="file-row"><span><span class="icon">📂</span><span class="name">assets</span></span><span class="meta">-</span><span class="meta">2026-09-15 11:47</span></div>
    <div class="file-row"><span><span class="icon">📄</span><span class="name">package.json</span></span><span class="meta">1.2 KB</span><span class="meta">2026-09-12 18:30</span></div>
    <div class="file-row"><span><span class="icon">🖼️</span><span class="name">cover.png</span></span><span class="meta">456 KB</span><span class="meta">2026-09-10 08:20</span></div>
  </div>
</div>
<div class="footer">Powered by ${title} · ${subtitle}</div>
</body>
</html>`;
}
